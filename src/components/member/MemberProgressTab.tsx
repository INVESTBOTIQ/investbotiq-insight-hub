            ...
            return (
              <div
                ...
                className={`p-4 sm:p-5 rounded-2xl border transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${
                  isCurrent
                    ? "bg-purple-50/80 dark:bg-purple-950/20 border-purple-300 dark:border-purple-800 shadow-md ring-1 ring-purple-400/30"
                    : isDone
                ...
                <div className="flex items-start sm:items-center gap-4">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm shrink-0 ${
                    isDone
                      ...
                      : isCurrent
                      ? "bg-purple-600 text-white shadow-md shadow-purple-600/30 ring-4 ring-purple-500/20"
                  ...
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {isCurrent && (
                        <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-purple-600 text-white animate-pulse">
                          Huidige Stap
                        </span>
                      )}
                      {isDone && (
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60 font-medium">
              {payoutHistory.map((tx) => (
                <tr key={tx.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                  <td className="py-3.5 font-mono text-purple-600 dark:text-purple-400 font-bold">{tx.id}</td>
                  ...
                  <td className="py-3.5 text-right">
                    <button
                      ...
                      className="p-1.5 rounded-lg text-purple-600 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors inline-flex"
